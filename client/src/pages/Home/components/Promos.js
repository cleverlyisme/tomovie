      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-10 items-center">
        <div className="flex lg:gap-10 gap-6 flex-col">
          ...
          <p className="text-text text-sm xl:text-base leading-6 xl:leading-8">
            ...
            Consequuntur et, tempora temporibus soluta numquam rerum molestias
            animi nisi explicabo praesentium, est corporis suscipit
            necessitatibus unde facere incidunt, ducimus adipisci deleniti?
          </p>
